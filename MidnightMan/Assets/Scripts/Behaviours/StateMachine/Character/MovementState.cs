...
namespace Behaviours.States
{
    class MovementState : CharacterState
    {
        ...
        {
            base.LogicUpdate();
            var movementInputs = _stateController.InputController.InputActions.PlayerActionList
        ...
        {
            base.InputHandle();
            var isMoving = _stateController.InputController.InputActions.PlayerActionList
